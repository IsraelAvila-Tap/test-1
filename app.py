...
def load_rentals_fallback() -> pd.DataFrame:
    ...
    find_and_rename(df, ["SVC","SVCs","LOGISTIC_CENTER_ID","FACILITY","LC"], "SVC", False, "Rentals")
    find_and_rename(df, ["Unidades disponibles","Units","Cantidad","Qty"], "CANT", False, "Rentals")
